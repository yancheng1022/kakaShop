...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${pageBean.list}" var="pro">
			...
			<a href="${pageContext.request.contextPath }/findProductByPid?pid=${pro.pid}&currentPage=${pageBean.currentPage}&cid=${cid}"> 
			<img src="${pageContext.request.contextPath }/${pro.pimage}"
				width="170" height="170" style="display: inline-block;">
			</a>
			<p>
				<a href="${pageContext.request.contextPath }/findProductByPid?pid=${pro.pid}&currentPage=${pageBean.currentPage}&cid=${cid}" style='color: green'>${pro.pname }</a>
			</p>
			<p>
