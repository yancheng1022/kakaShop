	...
	<head>
		...
		<script type="text/javascript">
			function delProFormCart(pid){
				if(confirm("您是否确认删除该项？")){
					location.href = "${pageContext.request.contextPath}/delFormProCart?pid="+pid;
				}
			}
			
			function clearCart(){
				if(confirm("您是否确认清空购物车？")){
	...
	<body>
		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${cart.cartItems }" var="entry">
								...
								<td>
									<a href="javascript:;" class="delete" onclick="delProFormCart('${entry.value.product.pid }')">删除</a>
								</td>
							</tr>
			...
			<div style="margin-right:130px;">
				...
				登录后确认是否享有优惠&nbsp;&nbsp;
			</em> 赠送积分: <em style="color:#ff6600;">${cart.total *2}</em>&nbsp; 商品金额: <strong style="color:#ff6600;">${cart.total }</strong>
				</div>
