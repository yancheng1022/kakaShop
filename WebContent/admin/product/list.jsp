...
<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/findCatalog";
			}
			
			function delProduct(pid){
				var isDel = confirm("您确认要删除吗？");
				if(isDel){
					location.href = "${pageContext.request.contextPath }/admainDelServlet?pid="+pid;
				}
			}
...
<body>
	<br>
	<form id="Form2" name="Form2" action="${pageContext.request.contextPath}/admainQueryServlet" method="post">
					<tr>
						<td class="ta_01" align="right" >商品名称	<input type="text" name="query"><input type="submit" value="查询" />
						</td>
					</tr>
			</form>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${products }" var="product" varStatus="vs">
								...
								<td align="center" style="HEIGHT: 22px">
									<a href="${ pageContext.request.contextPath }/adminEditServlet?pid=${product.pid}">
